							...
							<div class="col-md-6">
								...
								<!-- <div class="overlay">
									<div class="overlayText"><h2>2001</h2>
										<p>Me in my room with my first computer. </br></br> <h4>Note: the super cool, and not at all nerdy, signed George Takei photo in the background.</h4></p>
									</div>
								</div> -->
							</div>
							</div>
